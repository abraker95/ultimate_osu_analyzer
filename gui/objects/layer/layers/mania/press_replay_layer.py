...
class ManiaPressReplayLayer(Layer, Temporal):

    def __init__(self, data, time_driver):
        self.replay, self.columns = data
        self.columns = int(self.columns)

        Layer.__init__(self, 'Press times - ' + str(self.replay.player_name))
    ...
    def paint(self, painter, option, widget):
        ...
        painter.setPen(QPen(QColor(0, 0, 255, opacity), 5))
